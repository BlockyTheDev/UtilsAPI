...
public class TextParser {
     ...
     */
    public static String parseHexForChat(String message) {
     ...
     */
    public static String parseHexAndCodesForChat(String message) {
        return parseHexForChat(parseColorCodes(message));
    }
